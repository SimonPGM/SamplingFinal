...
Por ello, el objetivo de esta investigación nace con el propósito de ponerse en la posición de los estudiantes que cursan educación media en el Colegio Paula Montal, para así tener una perspectiva realista sobre la eficacia de este modelo educativo, a fin de que no solo esta institución, sino aquellas interesadas en generar conocimiento de calidad, se autoevalúen y así hagan las correcciones necesarias para refinar sistemas educativos más vanguardistas y aprovechar de este modo todos los beneficios que estos traen.  
