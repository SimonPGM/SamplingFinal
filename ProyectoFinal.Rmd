...
Como se mencionó anteriormente, la población fue estratificada por el grado de cada estudiante, con lo que se tiene un total de 3 estratos, siendo el grado noveno el primer estrato, décimo el segundo y undécimo el tercero, además cada estudiante respondió un total de 6 preguntas.
