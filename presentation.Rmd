---
title: "PROYECTO FINAL MUESTREO ESTADÍSTICO"
author:
  - Juan José Galeano Arenas
  - Simón Pedro Galeano Muñoz
  - Sebastián Gaviria Sánchez
...
```{r EDAED-plots1, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r results-plot1, echo=FALSE, fig.align='center'}
# Lectura BD
bd <- results
